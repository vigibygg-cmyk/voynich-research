...
def main():
    ...
    print("\n[*] STEP 2: GENERATOR 1 â€” N-GRAM MARKOV CHAIN")
    print("-" * 70)
    random.seed(42)
    ...
    print("\n[*] STEP 3: GENERATOR 2 â€” VIGENÃˆRE CIPHER")
    print("-" * 70)
